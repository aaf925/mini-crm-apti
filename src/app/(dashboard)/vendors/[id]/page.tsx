...
export default async function VendorProfilePage({ params }: { params: { id: string } }) {
  ...
  const ratings = [
    { label: "Technical Fit", score: vendor.technicalFit || 0 },
    { label: "Scalability", score: vendor.scalability || 0 },
    { label: "Post-Sale Support", score: vendor.postSaleSupport || 0 },
    { label: "Pricing / Value", score: vendor.pricingValue || 0 },
  ];
    ...
    <div className="p-8 space-y-10 max-w-[1400px] mx-auto animate-in slide-in-from-right-4 duration-700">
      ...
      <div className="flex items-center justify-between border-b border-outline-variant/10 pb-6">
        <div className="flex items-center gap-4 text-on-surface-variant font-bold text-[10px] uppercase tracking-widest">
            ...
            <span className="text-on-surface">Vendor Intelligence</span>
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-10 items-start">
          ...
          <div className="flex-1 space-y-4">
              ...
              <p className="text-xl text-on-surface-variant font-medium max-w-2xl">
                  {vendor.notes || "No additional technical notes provided for this evaluation cycle."}
              </p>
              <div className="flex items-center gap-8 pt-4">
                <div className="flex flex-col">
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40">Implementation</span>
                ...
                <div className="flex flex-col">
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40">Contract Owner</span>
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="glass-panel p-8 bg-surface-container-low flex flex-col justify-between">
                    <div className="flex justify-between items-start mb-8">
                        <h3 className="text-sm font-black uppercase tracking-widest text-on-surface">Technical Scoring</h3>
                ...
                <div className="glass-panel p-8 bg-surface-container flex flex-col">
                    <h3 className="text-sm font-black uppercase tracking-widest text-on-surface mb-8">Financial Overview</h3>
                    <div className="flex-1 flex flex-col justify-center space-y-10">
                        <div className="text-center">
                            <p className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant/40">Total Contract Value</p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 rounded-2xl bg-surface-container-high border border-outline-variant/10 text-center">
                                <p className="text-[8px] font-black uppercase text-on-surface-variant mb-1">Duration</p>
                                <p className="text-lg font-black text-on-surface">{vendor.estimatedMonths || "~"} Months</p>
                            </div>
                            <div className="p-4 rounded-2xl bg-surface-container-high border border-outline-variant/10 text-center">
                                <p className="text-[8px] font-black uppercase text-on-surface-variant mb-1">Type</p>
                ...
                <div className="md:col-span-2 glass-panel p-8 bg-gradient-to-tr from-surface-container-low to-surface-bright flex items-center gap-10">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 flex-1 gap-6">
                        <div>
                            <p className="text-[8px] font-black uppercase text-on-surface-variant mb-1">Key Contact</p>
                            <p className="text-sm font-bold text-on-surface">{vendor.contactName || "Unassigned"}</p>
                        </div>
                        <div>
                            <p className="text-[8px] font-black uppercase text-on-surface-variant mb-1">Work Email</p>
                            <p className="text-sm font-bold text-primary underline">{vendor.email || "N/A"}</p>
                        </div>
                        <div>
                            <p className="text-[8px] font-black uppercase text-on-surface-variant mb-1">Phone Number</p>
